...
export const DEFAULT_VALUES = { x: 0, y: 0, size: 48, radius: 12, border: 0, color: '#727c73', lift: 0, gap: 0, width:100, height:40, textColor:'#303331', backgroundColor:'#ffffff', opacity:100 };
...
export function stepValue(values, property, delta) {
  const bounds = { x: [-300, 300], y: [-300, 300], size: [16, 200], radius: [0, 100], border: [0, 12], lift: [-120, 200], gap: [-120, 200], width:[1,2000], height:[1,2000], opacity:[0,100] };
